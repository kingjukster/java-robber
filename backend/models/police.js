...
class Police {
  ...
  move(city) {
    ...
    for (const dir of validDirections) {
      if (
        city.cityGrid[dir.x][dir.y] instanceof Robber &&
        city.cityGrid[dir.x][dir.y].isActive
      ) {
        ...
        if (
          city.cityGrid[this.policeCoord.x] &&
          city.cityGrid[this.policeCoord.x][this.policeCoord.y]
        ) {
